...
import coreUI, { CoreUIState } from 'app/shared/reducers/coreui';

import device, { DeviceState } from 'app/entities/devices/device.reducer';
import policy, { PolicyState } from 'app/entities/policy/policy.reducer';
